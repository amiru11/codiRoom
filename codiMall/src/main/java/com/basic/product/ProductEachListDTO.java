...
public class ProductEachListDTO {
	
	private String productSize_size;
	private int productSize_each;
	...
	public int getProductSize_each() {
		return productSize_each;
	}
	public void setProductSize_each(int productSize_each) {
		this.productSize_each = productSize_each;
	}
