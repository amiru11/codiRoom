...
<form action="${pageContext.request.contextPath}/ttt/product_add" method="post" enctype="multipart/form-data">
	...
	<HR>
	PRODUCTINFO<BR>
	PRODUCT_PRICE<input type="number"  name="productInfo_price"><br>
	PRODUCT_saleRate<input type="number" step="0.1" name="productInfo_saleRate"><br>
	PRODUCT_searchWord<input type="text" name="productInfo_searchWord"><br>
	<hr>
	PRODUCT_EACH <button disabled="disabled">ADD</button><br>
	PRODUCTEACH_SIZE<input type="text" name="productEach_size"><br>
