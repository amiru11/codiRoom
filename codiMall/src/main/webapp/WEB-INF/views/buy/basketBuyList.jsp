	...
	<div class="container cart-body">
		<div class="row">
			<div class="col-sm-12">
				...
				<form id="tab_form" action="${pageContext.request.contextPath}/buy/basketBuy" method="post">
					<input type="hidden" name="buyState_address" id="inh_buyStateAddr">
							...
							<c:forEach var="list1" items="${list}">
								<tr>
									<td style="width: 200px;"><input type="hidden"
										name="basket_num" value="${list1.basket_num}"><input
										type="hidden" name="product_num" value="${list1.product_num}">
									...
									<td><input type="hidden" name=""
										value="${list1.productInfo_price}"> <fmt:formatNumber
											value="${list1.productInfo_price}" currencySymbol=""
											type="currency" />원</td>
									<td><input type="hidden" name=""
										value="${list1.productInfo_saleRate}">${list1.productInfo_saleRate}%</td>
									<td><input type="hidden" name=""
										value="${list1.basketInfo_size}">${list1.basketInfo_size}</td>
									<td><input type="hidden" name=""
										value="${list1.basketInfo_color}">${list1.basketInfo_color}</td>
									<td><input type="hidden" name=""
										value="${list1.basketInfo_each}">${list1.basketInfo_each}</td>
									<td><fmt:formatNumber
					...
					<div class="recipient-info">
						...
						<div class="clearfix">
							...
							<ul class="box_receiver_info list-inline">
								...
								<li
									class="cell_discount_detail2 order_address_form box_receiver">
							...
							<ul class="box_receiver_info list-inline">
								...
								<li><input type="text" id="post1"
									...
									type="text" id="ppost1"
									class="address form-control cl_member_addr2"
									readonly="readonly" name="m_zipcode" size="10"
									style="width: 200px; display: none;"> <input
									type="button" onclick="openDaumPostcode2()" value="우편번호 찾기"
									class="btn btn-default cl_member_addr2" style="display: none;"><br
									class="cl_member_addr2"> <input type="text" id="aaddr"
							...
							<ul class="box_receiver_info list-inline">
								...
								<li style="width: 800px;"><label> <input
									...
									<p class="box_detail_agree thirdAgreeDetail"
										...
										같이 공유하고 있습니다.<br> 1. 무신사((주)그랩)는 귀하께서 무신사 입점업체 판매자로부터 상품
										및 서비스를 구매하고자 할 경우, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 제 24조의 2(개인정보
										공유동의 등)에 따라 아래와 같은 사항은 안내하고 동의를 받아 귀하의 개인정보를 판매자에게 공유합니다.
										"개인정보 제3자 공유 동의"를 체크하시면 개인정보 공유에 대해 동의한 것으로 간주합니다.<br> 2.
										개인정보를 공유받는자 : 입점업체 상호명(주문마다 변경)<br> 3. 공유하는 개인정보 항목 : 구매자
										성명, 전화번호, ID, 휴대폰 번호, 상품 구매정보, 상품 수취인 정보(성명, 주소, 전화번호)<br>
										4. 개인정보를 공유받는 자의 이용 목적 : 판매자와 구매자의 거래의 원활한 진행, 본인의사의 확인, 고객 상담
										및 불만처리, 상품과 경품 배송을 위한 배송지 확인 등<br> 5. 개인정보를 공유받는 자의 개인정보
										보유 및 이용 기간 : 개인정보 수집 및 이용 목적 달성 시까지 보관합니다.<br> 6. 동의 거부 시
										불이익 : 본 개인정보 공유에 동의하지 않으시는 경우, 동의를 거부할 수 있으며, 이 경우 거래가 제한됩니다.
									</p>
									<p class="box_check_agree condition">
										<label> <input class="cl_pilsu_checkbox"
											type="checkbox" name="agree_pay"> <span>위 상품
												정보 및 거래 조건을 확인하였으며, 구매 진행에 동의 합니다.(필수)</span>
										</label>
									</p></li>
							</ul>
						</div>
