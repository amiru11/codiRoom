													...
													&nbsp;&nbsp;&nbsp;&nbsp;
														...
														<td>
															<div class="btn-group">
																...
																<input type="checkbox" class="checkSet" style="display: none;" value="${list1.board_num}">
																<ul class="dropdown-menu" role="menu" style="min-width: 55px;">
																      ...
																      <li style="text-align: center;"><a class="del-btn"  style="cursor: pointer;" onclick="delBtn(this);">삭제</a></li>
																</ul>														
															</div>
														</td>
													</tr>
