		...
		$(".div_cl_img_asd").on('click', function() {
			...
			$.ajax({
				...
				success : function(data) {
					...
					x = x + '<tr><td>productInfo_price</td><td>' + data.ar.productInfo_price + '</td></tr>';
					x = x + '<tr><td>productInfo_reg_date</td><td>' + data.ar.productInfo_reg_date + '</td></tr>';
					x = x + '<tr><td>productInfo_rec_date</td><td>' + data.ar.productInfo_rec_date + '</td></tr>';
					x = x + '<tr><td>productInfo_saleRate</td><td>' + data.ar.productInfo_saleRate + '</td></tr>';
					x = x + '<tr><td>productInfo_seachWord</td><td>' + data.ar.productInfo_searchWord + '</td></tr>';
					x = x + '<tr><td>productInfo_brand</td><td>' + data.ar.productInfo_brand + '</td></tr>';
					x = x + '</table><div></td>';
					...
					<div id="view">
						...
						<div id="selector">
							<div id="div_proSel_sel"
								style="float: left; width: 19%; height: 100px; overflow: scroll;">
								<c:forEach var="proselc" items="${productSelectList}">
						${proselc.productSelect_name}<input type="checkbox"
						...
						${proselc.kind_name}<input type="checkbox" name="kind_num"
						...
						${proselc.product_name}<input type="checkbox" name="product_num"
						...
						${proselc.productEach_color}<input type="checkbox"
