					...
					<div id="view">
						<header id="topbar" class="text-center bg-white alt ph10 br-b-ddd">
							<nav class="navbar">
								<div class="navbar-collapse collapse"
									...
									<ul id="category-type" class="nav navbar-nav"
										style="vertical-align: top; margin-left: 350px;">
										...
										<li class="category-li"><a id="4" class="sel_type">PRODUCT
												BOARD</a></li>
							...
							<div class="mt-30 hidden-xs">
								<a href="" class="subBtn btn btn-default btn-lg"> <span
									class="fa fa-list"></span> List
								</a> <a href="" class="subBtn btn btn-default btn-lg"> <span
									class="fa fa-pencil"></span> Write
								</a> <a href="" class="subBtn btn btn-default btn-lg"> <span
									class="fa fa-wrench"></span> Update
								</a>
							</div>
						</header>

						<section id="section" class="jumbotron"></section>
						<div id="rvl"></div>
					</div>
				</div>
			</div>
