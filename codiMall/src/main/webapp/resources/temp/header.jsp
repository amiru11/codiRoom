		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="${pageContext.request.contextPath}/member/scan">
					<input type="submit" class="btn btn-default form-control nLoginBtn"
						value="네이버 계정으로 로그인">
				</form>
				<div class="separator">
				...
				<form action="${pageContext.request.contextPath}/member/memberLogin"
					...
					<div class="form-group" style="color: #eee;">
						<input type="email" class="form-control decorative-input" id="idL"
							name="id" maxlength="30" placeholder="이메일" style="height:">
					</div>
					<div class="form-group">
						<input type="password" class="form-control decorative-input"
			...
			<div class="modal-footer">
				<a href="${pageContext.request.contextPath}/member/findFrom">아이디
					/ 패스워드 찾기</a> <span>취향저격의 계정이 없으세요?</span>
				<button type="button" class="btn btn-default" data-dismiss="modal"
					data-toggle="modal" data-target="#signModal">회원 가입</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="signModal" role="dialog">
	<div class="modal-dialog">
		<!-- Modal content-->
		<div class="modal-content">
			<form action="${pageContext.request.contextPath}/member/memberJoin"
				method="post" name="jfrm" id="jfrm">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<input type="email" class="form-control decorative-input" id="id"
							name="id" maxlength="30" placeholder="이메일" onblur="idCheck()">
					</div>
					<div class="form-group">
						<input type="password" class="form-control decorative-input"
							id="pw" name="pw" maxlength="15" placeholder="비밀번호">
					</div>
					<div class="form-group">
						<input type="password" class="form-control decorative-input"
							id="pwc" name="pwc" maxlength="15" placeholder="비밀번호 확인">
					</div>
					<div class="form-group">
						<input type="text" class="form-control decorative-input" id="name"
							name="name" maxlength="10" placeholder="이름">
					</div>
					<div class="form-group">
						<input type="date" class="form-control decorative-input"
							id="birth" name="birth" placeholder="생년월일을 입력하세요"
							max="${lastDate }" min="${startDate }">
					</div>
					<div class="form-group">
						<label for="gender">GENDER</label> <label class="radio-inline"><input
							type="radio" class="gender" name="gender" value="men">Men</label>
						<label class="radio-inline"><input type="radio"
							class="gender" name="gender" value="women">Women</label>
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon"
							style="background: none; border: none; padding: 0;"> <select
							class="form-control" id="tel0" name="tel0">
								<option value="SKT">SKT</option>
								<option value="KT">KT</option>
								<option value="LGU">LGU</option>
						</select>
						</span> <input type="tel" class="form-control decorative-input" id="tel1"
